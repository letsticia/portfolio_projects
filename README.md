...
| [🖖 Brazilian Sign Language Recognition](https://github.com/cilab-ufersa/ml_libras)| In progress (Current) | Python, MediaPipe, OpenCV, Scikit-learn, Pandas| An Cientific Initiation project that aims to reduce the communication barriers between hearing people and deaf ones. *Funded by CNPQ*.|
...
- **2024**: [1st place in the Hackathon of the 1st ECOP-SABIÁ](https://assecom.ufersa.edu.br/2024/09/10/ufersa-em-pau-dos-ferros-premia-participantes-do-i-hackathon-ecop-sabia/?fbclid=PAZXh0bgNhZW0CMTEAAaaCE0hPj7qpf3gluGRdc4vcBYJxVTPufdVBozzPKBZUXfvT50ot6U86v9U_aem_o84YHzEvE-MFfPHoSRDqig) (Encontro de Computação do Oeste Potiguar) with the project "CultivApp" - a mobile application that allows familiar agriculturists to make touch with the local market and sell their products, and also teach them how to cultivate their plants with classes from students of the Agricology couse. 

- **2024**: [Approved as GitHub Campus Expert](https://githubcampus.expert/letsticia/). This program takes student leaders that strive to build diverse and inclusive spaces to learn skills, share their experiences, and build projects together. GitHub Campus Experts can be found across the globe leading in-person and online conferences, meetups, and hackathons, and maintaining open-source projects.
