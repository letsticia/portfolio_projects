...
| [🖖 LIBRAS44](https://github.com/cilab-ufersa/libras44)| COMPLETE (Feb, 2025) | Python, OpenCV, MediaPipe, Scikit-learn | LIBRAS44 is a system for recognizing Brazilian Sign Language (LIBRAS) signs that uses computer vision and artificial intelligence techniques to identify and translate signs in real time into text and voice.|
